        ...
        return (
            <form onSubmit={this.submitRegister}>
                <div className="container">
                    ...
                    <p>Username</p>
                    <input value={this.state.username} onChange={e => this.changeInput(e)} type="text"
                           placeholder="Enter Username" name="username" required></input>
                    <p>Password</p>
                    <input value={this.state.password} onChange={e => this.changeInput(e)} type="password"
                           placeholder="Enter Password" name="password" required></input>
                    <p>Repeat Password</p>
                    <input value={this.state.passwordRepeat} onChange={e => this.changeInput(e)} type="password"
                           placeholder="Repeat Password" name="passwordRepeat" required></input>
